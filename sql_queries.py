...
sessionId bigint, song varchar, status int, ts bigint, userAgent varchar(512), userId bigint) DISTKEY(artist)
""")
...
artist_name varchar(512), artist_location varchar(512), artist_latitude real, artist_longitude real) \
...
UNIQUE (start_time, user_id, session_id)) DISTKEY(artist_id) SORTKEY(songplay_id)""")
